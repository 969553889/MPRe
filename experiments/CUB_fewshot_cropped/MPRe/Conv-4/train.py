...
sys.path.append('../../../../')
from trainers import trainer, MPRe_train
from datasets import dataloaders
from models.MPRe import MPRe
...
model = MPRe(way=train_way,
            shots=[args.train_shot, args.train_query_shot],
            resnet=args.resnet)

train_func = partial(MPRe_train.default_train,train_loader=train_loader)
